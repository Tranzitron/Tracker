// Layout overflow sweep - 640x720 snap-half window. One size per file: each
...
void main() {
  ...
  testWidgets('no overflow at 640x720-snap-half', (tester) async {
    await sweepSize(tester, '640x720-snap-half', const Size(640, 720));
  });
}
