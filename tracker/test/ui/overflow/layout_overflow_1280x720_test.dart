// Layout overflow sweep - 1280x720 default window. One size per file: each
...
void main() {
  ...
  testWidgets('no overflow at 1280x720-default', (tester) async {
    await sweepSize(tester, '1280x720-default', const Size(1280, 720));
  });
}
