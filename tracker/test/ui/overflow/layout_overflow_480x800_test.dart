// Layout overflow sweep - 480x800 tall window. One size per file: each
...
void main() {
  ...
  testWidgets('no overflow at 480x800-tall', (tester) async {
    await sweepSize(tester, '480x800-tall', const Size(480, 800));
  });
}
