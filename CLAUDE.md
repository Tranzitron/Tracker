...
- `ExerciseDetailPage` shows the profile; its historical stats/graphs land with analytics (Milestone 6). `SettingsPage`'s snackbar placeholders are still to be built (Milestone 7).
